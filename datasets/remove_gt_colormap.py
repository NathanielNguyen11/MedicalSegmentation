...
IN = '/home/ubuntu/Desktop/111/CVC-ClinicDB/Untitled Folder/Ground Truth1'
OT = '/home/ubuntu/Desktop/111/CVC-ClinicDB/Untitled Folder/Groundtruth_label'

tf.app.flags.DEFINE_string('original_gt_folder', default= IN,
                           
                           help='Original ground truth annotations.')

tf.app.flags.DEFINE_string('segmentation_format',default = 'png', help='Segmentation format.')

tf.app.flags.DEFINE_string('output_dir', default =OT,
